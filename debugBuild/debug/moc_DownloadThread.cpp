...
#include "../../src/src/download/DownloadThread.h"
...
QT_MOC_LITERAL(1, 15, 18), // "onDownloadStatusCB"
QT_MOC_LITERAL(2, 34, 0), // ""
QT_MOC_LITERAL(3, 35, 5), // "state"
QT_MOC_LITERAL(4, 41, 3), // "msg"
QT_MOC_LITERAL(5, 45, 20), // "onDownloadProgressCB"
QT_MOC_LITERAL(6, 66, 8) // "progress"

    },
    "DownloadThread\0onDownloadStatusCB\0\0"
    "state\0msg\0onDownloadProgressCB\0progress"
};
...
void DownloadThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->onDownloadStatusCB((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< QString(*)>(_a[2]))); break;
        case 1: _t->onDownloadProgressCB((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&DownloadThread::onDownloadStatusCB)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&DownloadThread::onDownloadProgressCB)) {
                *result = 1;
                return;
            }
        }
...
const QMetaObject DownloadThread::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_DownloadThread.data,
...
void *DownloadThread::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "DownloadProgressCallback"))
        return static_cast< DownloadProgressCallback*>(const_cast< DownloadThread*>(this));
...
// SIGNAL 0
void DownloadThread::onDownloadStatusCB(int _t1, QString _t2)
{
...
// SIGNAL 1
void DownloadThread::onDownloadProgressCB(int _t1)
{
