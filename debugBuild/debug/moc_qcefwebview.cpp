...
#include "../../src/src/cefclient/qcefwebview.h"
...
QT_MOC_LITERAL(12, 114, 9), // "jsMessage"
QT_MOC_LITERAL(13, 124, 4), // "name"
QT_MOC_LITERAL(14, 129, 4), // "args"
QT_MOC_LITERAL(15, 134, 4), // "back"
QT_MOC_LITERAL(16, 139, 7), // "forward"
QT_MOC_LITERAL(17, 147, 6), // "reload"
QT_MOC_LITERAL(18, 154, 4), // "stop"
QT_MOC_LITERAL(19, 159, 18), // "evaluateJavaScript"
QT_MOC_LITERAL(20, 178, 12) // "scriptSource"
    ...
    "jsMessage\0name\0args\0back\0forward\0"
    "reload\0stop\0evaluateJavaScript\0"
    "scriptSource"
};
...
static const uint qt_meta_data_QCefWebView[] = {
 ...
 // slots: parameters
    ...
    QMetaType::Void,
    QMetaType::Void,
    QMetaType::QVariant, QMetaType::QString,   20,
...
void QCefWebView::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 5: _t->jsMessage((*reinterpret_cast< const QString(*)>(_a[1])),(*reinterpret_cast< const QVariantList(*)>(_a[2]))); break;
        ...
        {
            typedef void (QCefWebView::*_t)(const QString & , const QVariantList & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QCefWebView::jsMessage)) {
                *result = 5;
                return;
            }
        }
...
void *QCefWebView::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "ClientHandler::Listener"))
        return static_cast< ClientHandler::Listener*>(const_cast< QCefWebView*>(this));
...
// SIGNAL 5
void QCefWebView::jsMessage(const QString & _t1, const QVariantList & _t2)
{
    void *_a[] = { Q_NULLPTR, const_cast<void*>(reinterpret_cast<const void*>(&_t1)), const_cast<void*>(reinterpret_cast<const void*>(&_t2)) };
